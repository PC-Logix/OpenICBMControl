...
public abstract class BlockControlbase extends Block implements ITileEntityProvider {
    protected Random random;

    public static final PropertyDirection PROPERTYFACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);

    protected BlockControlbase(String name, Material materialIn, float hardness) {
        super(materialIn);
        setUnlocalizedName("opencargo." + name);
        setRegistryName(com.pclogix.openicbmcontrol.OpenICBMControl.MODID, name);
