...
public class ICBMControllerTileEntity extends TileEntityOCBase implements ITickable {
    ...
    public ICBMControllerTileEntity() {
        super("oc_tagreader");
    ...
    private ItemStackHandler itemStackHandler = new ItemStackHandler(SIZE) {
        ...
        protected void onContentsChanged(int slot) {
            ...
            ICBMControllerTileEntity.this.markDirty();
        }
    };
