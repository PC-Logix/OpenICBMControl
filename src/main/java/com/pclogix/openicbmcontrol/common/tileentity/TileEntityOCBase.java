package com.pclogix.openicbmcontrol.common.tileentity;
...
public class TileEntityOCBase extends TileEntity implements ITickable, ManagedEnvironment {
    ...
    protected void initOCFilesystem(String path, String name) {
        oc_fs = li.cil.oc.api.FileSystem.asManagedEnvironment(li.cil.oc.api.FileSystem.fromClass(com.pclogix.openicbmcontrol.OpenICBMControl.class, com.pclogix.openicbmcontrol.OpenICBMControl.MODID, path), name);
